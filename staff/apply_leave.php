...
//These must be at the top of your script, not inside a function
	...
	elseif($leave_days <= 0)
	{
		...
		if($lastInsertId)
		{
			echo "<script>alert('Your Leave Application was successful.');</script>";
...
try {
    ...
    //Recipients
    $mail->setFrom('mr.spongebob404@gmail.com', 'Bonty');
    $mail->addAddress('omuneeliud254@gmail.com', 'Eliud O');     //Add a recipient
    //$mail->addAddress('ellen@example.com');               //Name is optional
    $mail->addReplyTo('albertdigara@gmail.com', 'Albert D');
    ...
    $mail->Body    = 'Applying for leave MUST<b>in bold!</b>';
    $mail->AltBody = 'I am applying for a leave';
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											<label>Leave Reliever :</label>
											<select name="leave_reliever" class="custom-select form-control" required="true" autocomplete="off">
												<option value="">Select reliever...</option>
												<?php
												$department = 'ICT'; // Set the department here
												$sql = "SELECT FirstName, LastName FROM tblemployees WHERE Department = :department";
												$query = $dbh->prepare($sql);

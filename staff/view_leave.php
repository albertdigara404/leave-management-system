...
if (isset($_GET['cancel'])) {
	...
	$sql = "DELETE FROM tblleaves where id = ".$leave_id;
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Registrar Status</b></label>
							...
							<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="cancel" id="cancel" data-toggle="modal">Cancel&nbsp;Leave</button>
											</div>
										</div>
							</div>
